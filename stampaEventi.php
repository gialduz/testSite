    ...
    $sql = "SELECT E.id, E.nome AS evento, E.durata, E.eta_min, E.eta_max, E.ticket, E.speciale_ragazzi, E.descrizione_eng AS descr, tE.nome AS tipo FROM Evento AS E INNER JOIN tipologiaEvento AS tE ON e.tipologia=tE.id ORDER BY E.id";
